					  ...
					  <div class="box-body">
						...
						<!-- Color Picker -->
						  <div class="form-group pull-right">
							...
							<div class="input-group my-colorpicker2 colorpicker-element col-sm-10 pull-right">
							  <input type="text" class="form-control" placeholder="Enter or select highlight...">
								...
								<div class="col-xs-12">
								  <div class="box">
									<div class="box-header" style="background: #E3FDE3; !Important">
									  <h3 class="box-title" >Map for: Zig</h3>
